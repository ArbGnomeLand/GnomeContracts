...
contract BondTeller is ITeller, GnomeAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sGNOME remaining to be paid. agnostic balance
    ...
    IsGNOME internal immutable sGNOME; // payment token
    ...
    function newBond(
        ...
        GNOME.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        GNOME.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sGNOME.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of GNOME available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of GNOME available for claim for array of bonds
     * @param _bonder address
        ...
        returns (uint256 pending_)
    {
        ...
        pending_ = sGNOME.fromG(pending_);
    }

...
// types
import "../types/GnomeAccessControlledV2.sol";
 ...
 * @title BaseAllocator
 * @notice
 *  This abstract contract serves as a template for writing new Gnome Allocators.
 ...
 */
abstract contract BaseAllocator is GnomeAccessControlledV2, IAllocator {
    ...
    constructor(AllocatorInitData memory data)
        GnomeAccessControlledV2(data.authority)
    {
        _tokens = data.tokens;

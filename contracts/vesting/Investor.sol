...
/**
 *  This contract allows Gnome seed investors and advisors to claim tokens.
...
contract InvestorClaimV2 is Ownable {
    ...
    IClaim internal immutable previous =
        IClaim(0xaCCC8306455BaA01593Fa6267809fEA72F684169);
    ...
    function claimed(address _address) public view returns (uint256) {
        return gGNOME.balanceFrom(terms[_address].gClaimed);
    }

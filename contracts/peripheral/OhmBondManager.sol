...
import {IGnomeAuthority} from "../interfaces/IGnomeAuthority.sol";
import {GnomeAccessControlled} from "../types/GnomeAccessControlled.sol";

contract GnomeBondManager is GnomeAccessControlled {
    // ========= DATA STRUCTURES ========= //
    ...
    constructor(
        ...
        address authority_
    ) GnomeAccessControlled(IGnomeAuthority(authority_)) {
        ohm = IERC20(ohm_);
        ...
        returns (uint256)
    {
        ...
        uint256 marketId = fixedExpiryAuctioneer.createMarket(
            createMarketParams
        );

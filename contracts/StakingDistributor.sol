...
contract Distributor is IDistributor, GnomeAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    IERC20 private immutable gnome;
    ...
    /**
        ...
        @return uint
     */
    function nextRewardAt(uint256 _rate)
        public
        view
        override
        returns (uint256)
    {
        return gnome.totalSupply().mul(_rate).div(rateDenominator);
    }

...
contract gGNOME is IgGNOME, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sGNOME)
        ERC20("Governance GNOME", "gGNOME", 18)
    {
     ...
     * @param _sGNOME address
     */
    function migrate(address _staking, address _sGNOME)
        external
        override
        onlyApproved
    {
        ...
        require(_sGNOME != address(0), "Zero address found");
        sGNOME = IsGNOME(_sGNOME);
    }
    ...
    /**
     * @notice pull index from sGNOME token
     */
    ...
    /**
        @notice converts gGNOME amount to GNOME
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts GNOME amount to gGNOME
        @param _amount uint
        @return uint
     */
        ...
        returns (uint256)
    {
        require(
            ...
            "gGNOME::getPriorVotes: not yet determined"
        );

...
contract OlymppusERC20TokenTest is DSTest {
    GnomeERC20Token internal ohmContract;

    IGnomeAuthority internal authority;
    ...
    function test_erc20() public {
        ...
        ohmContract = new GnomeERC20Token(address(authority));
        assertEq("Gnome", ohmContract.name());
        assertEq("GNOME", ohmContract.symbol());

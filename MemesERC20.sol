...
contract MEMEs is ERC20Permit, Ownable {
    using LowGasSafeMath for uint256;
    ...
    constructor() ERC20("Gnome MEMEs", "MEME", 9) ERC20Permit() {
    ...
    /**
        @notice increases MEMEs supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess MEMEs

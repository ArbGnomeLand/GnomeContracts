export const CONTRACTS: Record<string, string> = {
    gnome: "GnomeERC20Token",
    sGnome: "sGnome",
    gGnome: "gGNOME",
    staking: "GnomeStaking",
    distributor: "Distributor",
    treasury: "GnomeTreasury",
    bondDepo: "GnomeBondDepository",
    teller: "BondTeller",
    bondingCalculator: "GnomeBondingCalculator",
    authority: "GnomeAuthority",
    migrator: "GnomeTokenMigrator",
    FRAX: "Frax",
    DAI: "DAI",
};
